...
contextBridge.exposeInMainWorld("reckAPI", {
  ...
  /**
   * Phase B Task 8 — component-preview capability probe.
   * `detect(projectRoot, filePath)` asks main whether the file at
   * `filePath` inside `projectRoot` is previewable as a live React
   * component (a Vite + React project, read over the sshfs mount). The
